...
const handlePlaceOrder = async()=>{
    try {
        ...
        const response = await axios.post('http://"Your IP Address":8000/orders',orderData)
  ...
  return (
    <ScrollView style={{marginTop:55}}>
      ...
      {currentStep===0 && (
        <View style={{marginHorizontal:20}}>
            ...
            <Pressable>
                {addresses.map((item,i)=><Pressable style={{borderWidth:1,borderColor:'#D0D0D0',padding:10,flexDirection:'row',alignItems:'center',gap:5,paddingBottom:17,marginVertical:7,borderRadius:6}} >
    ...
    {currentStep===1 && (
        <View style={{marginHorizontal:20}} >
            ...
            <View style={{flexDirection:'row',alignItems:'center',backgroundColor:'white',padding:8,gap:7,borderColor:'#D0D0D0',borderWidth:1,marginVertical:10}} >
            {option ? (
                    <FontAwesome5 name="dot-circle" size={20} color="#008397" />
            ...
            <Pressable onPress={()=>setCurrentStep(2)} style={{backgroundColor:'#FFC72C',padding:10,borderRadius:20,justifyContent:'center',alignItems:'center'}} >
                <Text>Continue</Text>
            </Pressable>
        </View>
    )}
    ...
    {currentStep===2 &&(
        <View style={{marginHorizontal:20}} >
            ...
            <Entypo onPress={()=>{setSelectedOption('card');
            ...
            <Pressable onPress={()=>setCurrentStep(3)} style={{backgroundColor:'#FFC72C',padding:10,borderRadius:20,justifyContent:'center',alignItems:'center',marginTop:10}} >
                <Text>Continue</Text>
            </Pressable>
        </View>
    )}
